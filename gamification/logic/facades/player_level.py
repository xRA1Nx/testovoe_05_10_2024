...
def player_levels__csv_report(*, player_levels: QuerySet[PlayerLevel] | None = None) -> bytes:
    """
    Получение отчета в формате .csv по Уровням игрока и вознаграждений за их прохождения.
    """
